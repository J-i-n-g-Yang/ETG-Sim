...
GAME_ID='roulette_single_zero'; NAME='Roulette'; ICON="🎡"
POCKETS=tuple([0]+list(range(1,37)))
STRAIGHT_POCKETS=frozenset(POCKETS)
EXTRA_SPLITS=frozenset({(0,1),(0,2),(0,3)})
EXTRA_STREETS=frozenset(set())
EXTRA_CORNERS=frozenset({(0,1,2,3)})
